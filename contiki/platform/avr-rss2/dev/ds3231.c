...
void ds3231_get_datetime(datetime_t *datetime) {
    ...
    i2c_stop();
    i2c_start(RTC_RADDR);
    // datetime->secs = bcd_to_dec(20);
    // datetime->mins = bcd_to_dec(45);
    // datetime->hours = bcd_to_dec(19);
    // datetime->wday = bcd_to_dec(5);
    // datetime->day = bcd_to_dec(5);
    // datetime->month = bcd_to_dec(9);
    // datetime->year = bcd_to_dec(2019);
